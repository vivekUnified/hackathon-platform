...
const HackathonsPage: React.FC = () => {
  ...
  const hackathons = isSuccess && data ? data.map(d =>{return {...d, ...d.attributes}}) : [];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {isSuccess && hackathons.map((hackathon) => (
          <div key={hackathon.id} className="bg-white rounded-md shadow-md p-6">
            ...
            <p className="text-gray-600 mb-3">{JSON.stringify(hackathon.description)}</p>
            ...
            {hackathon.type && <p className="text-sm text-gray-500 mb-1">Mode: {hackathon.type}</p>}
